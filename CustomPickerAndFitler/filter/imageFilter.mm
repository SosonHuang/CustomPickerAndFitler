...
-(UIImage *)processIma:(cv::Mat)inputImage oldImage:(UIImage *)maskImage number:(int)randomNumber sliderValueOne:(float)valueOne sliderValueTwo:(float)valueTwo
{
    cv::Mat inputMat = inputImage;
    cv::Mat resultMat;
    cv::Mat maskMat;
